@include('layouts.user-head-top')

  @include('user-pages.preloader')
  ...
  <main>
    ...
    <section class="section-bg layout-pt-lg layout-pb-lg">
      <div class="section-bg__item col-12">
        <img src="{{ asset('assets/images/pages/about/1.png') }}" alt="image">
      </div>
    ...
    <section class="layout-pt-md">
      <div class="container">
        <div class="row y-gap-30 justify-between items-center">
          ...
          <div class="col-lg-6">
            <img src="{{ asset('assets/images/pages/about/2.png') }}" alt="image" class="rounded-4">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="overflow-hidden pt-40 js-section-slider" data-gap="30" data-slider-cols="xl-5 lg-4 md-2 sm-2 base-1" data-nav-prev="js-team-prev" data-pagination="js-team-pag" data-nav-next="js-team-next">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{ asset('assets/images/team/1.png') }}" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{ asset('assets/images/team/2.png') }}" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{ asset('assets/images/team/3.png') }}" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{ asset('assets/images/team/4.png') }}" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{ asset('assets/images/team/5.png') }}" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{ asset('assets/images/team/6.png') }}" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="{{ asset('assets/images/team/7.png') }}" alt="image" class="rounded-4 col-12">
              ...
              <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40">
                ...
                <div class="pt-20 mt-28 border-top-light">
                  <div class="row x-gap-20 y-gap-20 items-center">
                    <div class="col-auto">
                      <img class="size-60" src="{{ asset('assets/images/avatars/1.png') }}" alt="image">
                    </div>
          ...
          <div class="col-xl-8">
            <div class="row y-gap-30 justify-between items-center">
              ...
              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="{{ asset('assets/images/clients/1.svg') }}" alt="image">
                </div>
              </div>

              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="{{ asset('assets/images/clients/2.svg') }}" alt="image">
                </div>
              </div>

              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="{{ asset('assets/images/clients/3.svg') }}" alt="image">
                </div>
              </div>

              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="{{ asset('assets/images/clients/4.svg') }}" alt="image">
                </div>
              </div>
            ...
            <div class="row x-gap-20 y-gap-20">
              <div class="col-md-auto">
                <div class="ratio ratio-1:1 size-120">
                  <img src="{{ asset('assets/images/hotels/1.png') }}" alt="image" class="img-ratio rounded-4">
                </div>
              </div>
...
@include('layouts.user-head-bottom')