<?php $__env->startSection('content'); ?>
  ...
  <div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
    <div class="col-auto">
      <h1 class="text-30 lh-14 fw-600">All Packages</h1>
    </div>
    <div class="col-auto">
      <a href="db-vendor-add-hotel.html" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">
        Add Package <div class="icon-arrow-top-right ml-15"></div>
      </a>
    </div>
  </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="row x-gap-10 y-gap-10 items-center">
                      ...
                      <div class="col-auto">
                        <a href="db-vendor-add-hotel.html?packageId=6&type=view" class="flex-center bg-light-2 rounded-4 size-35">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\travel\resources\views/admin/packages.blade.php ENDPATH**/ ?>