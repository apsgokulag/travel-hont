      ...
      <div class="row justify-end">
        <div class="col-xl-5 col-lg-7">
          <div class="map-form px-40 pt-40 pb-50 lg:px-30 lg:py-30 md:px-24 md:py-24 bg-white rounded-4 shadow-4">
            ...
            <form action="<?php echo e(route('web.contact')); ?>" method="POST">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\travel\resources\views/web/contact.blade.php ENDPATH**/ ?>