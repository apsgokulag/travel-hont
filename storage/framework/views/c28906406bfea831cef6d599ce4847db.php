      ...
      <div class="row y-gap-30">
        <div class="col-xl-3 col-lg-4 lg:d-none">
          <aside class="sidebar y-gap-40">     
            <form action="<?php echo e(route('web.filter.package')); ?>" method="GET"> 
              <?php echo csrf_field(); ?>  
              <div class="sidebar__item -no-border">
                ...
                <div class="single-field relative d-flex items-center py-10">
                  <input class="pl-50 border-light text-dark-1 h-50 rounded-8" type="text"
                    placeholder="e.g. Paris" name="package" <?php if(isset($destText)): ?> value="<?php echo e($destText); ?>" <?php endif; ?>>
        ...
        <div class="col-xl-9 col-lg-8">
          <div class="row y-gap-10 items-center justify-between">
            <div class="col-auto">
              <div class="text-18"><span class="fw-500"><?php echo e($packagesCount); ?> packages</span> </div>
            </div>
                  ...
                  <div class="row x-gap-20 y-gap-20">
                    ...
                    <div class="col-md">
                      ...
                      <div class="text-14 lh-15 mt-20">
                        <div class="fw-500"><?php echo e(Str::limit($package->overview, 250)); ?></div>
                      </div>
                      ...
                      <div class="row x-gap-10 y-gap-10 pt-20">
                        <?php $__currentLoopData = $package->highlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $highlight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                            
                          <div class="col-auto">
                            <div class="border-light rounded-100 py-5 px-20 text-14 lh-14"><?php echo e($highlight->highlight); ?></div>
                          </div>
                    ...
                    <div class="col-md-auto text-right md:text-left">
                      <div class="row x-gap-10 y-gap-10 justify-end items-center md:justify-start">
                        <div class="col-auto">
                          ...
                          <div class="text-14 lh-14 text-light-1"><?php echo e(count($package->reviews->reject(function($review){
                      return !$review->approved;
                    }))); ?> reviews</div>
                        </div>
                        <div class="col-auto">
                          <div class="flex-center text-white fw-600 text-14 size-40 rounded-4 bg-blue-1"><?php echo e(number_format($package->ratings->avg('rating'), 1, '.', ',')); ?></div>
                        </div>
                      </div>

                      <div class="mt-4">
                        <div class="text-14 text-light-1">Adult</div>
                        <div class="text-22 lh-12 fw-600 mt-5">US $ <?php echo e($package->price->adult_amount); ?> </div>
                        <div class="text-14 text-light-1">Children</div>
                        <div class="text-22 lh-12 fw-600 mt-5">US $ <?php echo e($package->price->children_amount); ?></div>

                        <a href="<?php echo e(route('package', ['slug' => $package->slug])); ?>" class="button -md -dark-1 bg-blue-1 text-white mt-24">
      ...
      if(isset($ratings)){
        foreach($ratings as $eachRating){ ?>
          document.querySelectorAll('.rating-filter-each-button').forEach(option => {
            if(option.innerText == "<?php echo $eachRating; ?>"){
...
<?php echo $__env->make('web.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\travel\resources\views/web/packages.blade.php ENDPATH**/ ?>