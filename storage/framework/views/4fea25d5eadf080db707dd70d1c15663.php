          ...
          <div class="row y-gap-30 items-center">
            <div class="col-auto">
              <div class="d-flex ratio ratio-1:1 w-200">
                <img src="<?php echo e(asset('assets/images/misc/avatar-1.png')); ?>" alt="image" class="img-ratio rounded-4">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\travel\resources\views/admin/settings.blade.php ENDPATH**/ ?>