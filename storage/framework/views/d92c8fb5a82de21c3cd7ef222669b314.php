<?php echo $__env->make('layouts.user-head-top', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

  <?php echo $__env->make('user-pages.preloader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

  <main>
    <div class="header-margin"></div>
    
    <?php echo $__env->make('user-pages.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <section class="section-bg layout-pt-lg layout-pb-lg">
      <div class="section-bg__item col-12">
        <img src="<?php echo e(asset('assets/images/pages/about/1.png')); ?>" alt="image">
      </div>
      ...
      <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-40 justify-between pt-50">
          ...
          <div data-anim-child="slide-up delay-2" class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="#" data-src="<?php echo e(asset('assets/images/featureIcons/1/1.svg')); ?>" alt="image" class="js-lazy">
              </div>
          ...
          <div data-anim-child="slide-up delay-3" class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="#" data-src="<?php echo e(asset('assets/images/featureIcons/1/2.svg')); ?>" alt="image" class="js-lazy">
              </div>
          ...
          <div data-anim-child="slide-up delay-4" class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="#" data-src="<?php echo e(asset('assets/images/featureIcons/1/3.svg')); ?>" alt="image" class="js-lazy">
              </div>
    ...
    <section class="layout-pt-md">
      <div class="container">
        <div class="row y-gap-30 justify-between items-center">
          ...
          <div class="col-lg-6">
            <img src="<?php echo e(asset('assets/images/pages/about/2.png')); ?>" alt="image" class="rounded-4">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="overflow-hidden pt-40 js-section-slider" data-gap="30" data-slider-cols="xl-5 lg-4 md-2 sm-2 base-1" data-nav-prev="js-team-prev" data-pagination="js-team-pag" data-nav-next="js-team-next">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="<?php echo e(asset('assets/images/team/1.png')); ?>" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="<?php echo e(asset('assets/images/team/2.png')); ?>" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="<?php echo e(asset('assets/images/team/3.png')); ?>" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="<?php echo e(asset('assets/images/team/4.png')); ?>" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="<?php echo e(asset('assets/images/team/5.png')); ?>" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="<?php echo e(asset('assets/images/team/6.png')); ?>" alt="image" class="rounded-4 col-12">
            ...
            <div class="swiper-slide">
              <div class="">
                <img src="<?php echo e(asset('assets/images/team/7.png')); ?>" alt="image" class="rounded-4 col-12">
              ...
              <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40">
                ...
                <div class="pt-20 mt-28 border-top-light">
                  <div class="row x-gap-20 y-gap-20 items-center">
                    <div class="col-auto">
                      <img class="size-60" src="<?php echo e(asset('assets/images/avatars/1.png')); ?>" alt="image">
                    </div>
          ...
          <div class="col-xl-8">
            <div class="row y-gap-30 justify-between items-center">
              ...
              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="<?php echo e(asset('assets/images/clients/1.svg')); ?>" alt="image">
                </div>
              </div>

              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="<?php echo e(asset('assets/images/clients/2.svg')); ?>" alt="image">
                </div>
              </div>

              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="<?php echo e(asset('assets/images/clients/3.svg')); ?>" alt="image">
                </div>
              </div>

              <div class="col-md-auto col-sm-6">
                <div class="d-flex justify-center">
                  <img src="<?php echo e(asset('assets/images/clients/4.svg')); ?>" alt="image">
                </div>
              </div>
            ...
            <div class="row x-gap-20 y-gap-20">
              <div class="col-md-auto">
                <div class="ratio ratio-1:1 size-120">
                  <img src="<?php echo e(asset('assets/images/hotels/1.png')); ?>" alt="image" class="img-ratio rounded-4">
                </div>
              </div>
...
<?php echo $__env->make('layouts.user-head-bottom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\travel\resources\views/user-pages/about.blade.php ENDPATH**/ ?>